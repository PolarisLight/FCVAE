...
if __name__ == "__main__":
    if opt.preprocess:
        if opt.mode == 'S':
            prepare_data(data_path='LOLdataset/our485', patch_size=64, stride=40, aug_times=1)
        if opt.mode == 'B':
            prepare_data(data_path='LOLdataset/our485', patch_size=64, stride=10, aug_times=1)
    main()
